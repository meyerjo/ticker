"""
Django settings for ticker_django project.
...
SECRET_KEY = '^i^25w-74^wo)2q0ct70%ra2964g#9_lsd@%wfmmq04ny*3oh!'
...
ROOT_URLCONF = 'ticker_django.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'ticker', 'templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ticker_django.wsgi.application'
